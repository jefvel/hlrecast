...
class RecastConfig {
    ...
    public var cs : F32 = 0.1;
    public var ch : F32 = 0.1;
    ...
    public var walkableSlopeAngle : F32 = 3.2;

    public var walkableHeight : Int = 1;
    public var walkableClimb : Int = 0;
    public var walkableRadius : F32;
    ...
    public var maxVertsPerPoly : Int = 3;
